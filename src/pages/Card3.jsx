...
const Card3 = () => {
  return (
    <div className='mt-[85px] items-center pr-[15px] '>
            <div className="rounded-xl p-4 bg-[#f0f0f0] w-[250px] h-[200px] bg-[url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0qkzD0e4_jNguNfEKk4IWP3u5Is2KxUN8uQ&s')] bg-cover bg-center bg-no-repeat text-white">
